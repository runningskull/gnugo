...
static struct autohelper_func autohelper_functions[] = {
  ...
  {"xdefend_against",		2, 0, 1.00,
		"defend_against(goban, %s, OTHER_COLOR(color), %s)"},
  ...
  {"x_alive_somewhere",		0, 1, 0.01,
		"somewhere(goban, OTHER_COLOR(color), 1, %d"},
  {"o_alive_somewhere",		0, 1, 0.01, "somewhere(goban, color, 1, %d"},
  ...
  {"oplay_defend_both",		2, 1, 3.00,
		"play_attack_defend2_n(goban, color, 0, %d"},
  {"xplay_attack_either",	2, 1, 3.00,
		"play_attack_defend2_n(goban, OTHER_COLOR(color), 1, %d"},
  {"oplay_attack_either",	2, 1, 3.00,
		"play_attack_defend2_n(goban, color, 1, %d"},
  {"xplay_defend",		1, 1, 1.00,
		"play_attack_defend_n(goban, OTHER_COLOR(color), 0, %d"},
  {"oplay_defend",		1, 1, 1.00,
		"play_attack_defend_n(goban, color, 0, %d"},
  {"xplay_attack",		1, 1, 1.00,
		"play_attack_defend_n(goban, OTHER_COLOR(color), 1, %d"},
  {"oplay_attack",		1, 1, 1.00,
		"play_attack_defend_n(goban, color, 1, %d"},
  {"xplay_break_through",	3, 1, 5.00,
		"play_break_through_n(goban, OTHER_COLOR(color), %d"},
  {"oplay_break_through",	3, 1, 5.00,
		"play_break_through_n(goban, color, %d"},
  {"oplay_connect",		2, 1, 10.00,
		"play_connect_n(goban, color, 1, %d"},
  {"xplay_connect",		2, 1, 10.00,
		"play_connect_n(goban, OTHER_COLOR(color), 1, %d"},
  {"oplay_disconnect",		2, 1, 10.00,
  ...
  {"o_visible_along_edge",	2, 0, 0.05,
		"visible_along_edge(goban, color, %s, %s)"},
  {"x_visible_along_edge",	2, 0, 0.05, 
                "visible_along_edge(goban, OTHER_COLOR(color), %s, %s)"},
