...
# ADD CPP /nologo /W3 /GX /O2 /I "." /I ".." /I "..\sgf" /I "..\patterns"  /I "..\utils" /I "../engine" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAVE_CONFIG_H" /FR /YX /FD /c
...
# ADD LINK32 ..\sgf\Release\sgf.lib ..\engine\Release\engine.lib ..\patterns\Release\patterns.lib ..\utils\Release\utils.lib wsock32.lib ..\patterns\Release\dfa.lib /nologo /subsystem:console /incremental:yes 
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "." /I ".." /I "..\sgf" /I  "..\patterns" /I "..\utils" /I "../engine" /D "WIN32" /D "_DEBUG" /D  "_CONSOLE" /D "_MBCS" /D "HAVE_CONFIG_H" /FR /YX /FD /I /GZ /c
